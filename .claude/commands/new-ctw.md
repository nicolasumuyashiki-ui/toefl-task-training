...
### 概要
- 1 Practice = 2セット（Set 1: Module 2 easy〜Module 1 / Set 2: Harder Module 相当）
...
- **Set 1**: CEFR B1-B2（Module 2 easy〜Module 1 相当）
  - 日常的な学術トピック（教育、健康、環境、歴史など）
  - 基本的な学術語彙（significant, demonstrate, environment 等）
  - 接頭辞は3-4文字表示（残り2-3文字入力）、平均入力2〜3文字
- **Set 2**: CEFR B2-C1（Harder Module 相当）
  - やや専門的なトピック（生態学、神経科学、経済学など）
  - 高度な学術語彙（hypothesis, synthesize, accumulate 等）
  - 接頭辞は2-3文字表示（残り3-5文字入力）、平均入力3〜4文字
...
#### ヒント設計ルール
**Set 1（易しめ）**:
- MOD問題: 先頭3-4文字を表示（残り2-3文字を入力）
- HARD問題: 先頭2-3文字を表示（残り3-4文字を入力）

**Set 2（Harder 相当）**:
- MOD問題: 先頭2-3文字を表示（残り3-4文字を入力）
- HARD問題: 先頭1-2文字を表示（残り4-6文字を入力）
