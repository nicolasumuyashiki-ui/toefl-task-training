# 個別指導講師の方へ — TCK Reps アプリ仕様の概要

TCK Workshop の TOEFL® 学習アプリ「TCK Reps」をご利用中の生徒さんへの個別指導を担当いただきありがとうございます。下記、アプリの仕組みと講師の関わり方をまとめます。
...
- **申し込み**: 生徒さんが `private-coaching.html` から `reps-support@tckworkshop.co.jp` にメール → 事務局経由で先生にお繋ぎ
